...
public class PlayerActivity extends AppCompatActivity {
    // define Buttons, TextView, SeekBar, BarVisualizer & ImageView
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // assign buttons, visualizer and imageview to id
        ...
        // if media player isn't playing it stops and release song
        if (mediaPlayer != null)
        {
            mediaPlayer.stop();
            mediaPlayer.release();
    ...
    // animation of imageView (Music Note)
